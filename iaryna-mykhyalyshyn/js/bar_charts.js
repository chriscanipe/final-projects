...
// Get the data
d3.csv("data/all_30.csv", function(error, data) {
...
function draw(year){
  ...
  d3.select('svg').append("path.arrow")
    ...
    .datum([[width/3.5,height/1.1],[width/2.5 - 30,height/1.2]])
    .attr("d", swoopy)
    ...
    var text2 = svg.selectAll("text.annotation")
        ...
        var textNote2 = text2
            .attr("x", width/6)
            .attr("y", height/1.1)
            .text("Exeptions of sea level increase");
